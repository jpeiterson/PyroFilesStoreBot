...
async def start(bot, cmd):
	...
	if usr_cmd == "/start":
		...
		await cmd.reply_text(
			...
			parse_mode="Markdown",
			disable_web_page_preview=True,
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Channel", url="https://t.me/CyrusProjects"), InlineKeyboardButton("Owner", url="https://t.me/cyrusexplode")]])
		)
	else:
		if Config.UPDATES_CHANNEL:
			invite_link = await bot.export_chat_invite_link(int(Config.UPDATES_CHANNEL))
				...
				await bot.send_message(
					...
					reply_markup=InlineKeyboardMarkup(
						[
							...
							[
								InlineKeyboardButton("🔄 Refresh / Try Again", url=f"https://telegram.dog/{BOT_USERNAME}?start=cyrusexplode_{file_id}")
							]
						]
					),
					parse_mode="markdown"
		...
		try:
			...
			await send_stored_file.reply_text(f"**Here is Sharable Link of this file:** https://telegram.dog/{BOT_USERNAME}?start=cyrusexplode_{file_id}\n\n__To Retrive the Stored File, just open the link!__", disable_web_page_preview=True, quote=True)
...
async def main(bot, message):
	if message.chat.type == "private":
		...
		try:
			...
			share_link = f"https://telegram.dog/{BOT_USERNAME}?start=cyrusexplode_{file_er_id}"
			await editable.edit(
				f"**Your File Stored in my Database!**\n\nHere is the Permanent Link of your file: {share_link} \n\nJust Click the link to get your file!",
				parse_mode="Markdown",
				reply_markup=InlineKeyboardMarkup(
					[[InlineKeyboardButton("Open Link", url=share_link)], [InlineKeyboardButton("Bots Channel", url="https://t.me/CyrusProjects"), InlineKeyboardButton("Support Group", url="https://t.me/Flix_movies_lk")]]
				),
				disable_web_page_preview=True
			)
		except Exception as err:
	...
	if "aboutbot" in cb_data:
		await cmd.message.edit(
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Sponsor Group", url="https://t.me/Flix_movies_lk")
					],
					[
		...
		await cmd.message.edit(
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Support Group", url="https://t.me/Flix_movies_lk"),
						InlineKeyboardButton("Bots Channel", url="https://t.me/CyrusProjects")
					],
					[
						InlineKeyboardButton("About Bot", callback_data="aboutbot"),
						InlineKeyboardButton("About Dev", callback_data="aboutdevs")
